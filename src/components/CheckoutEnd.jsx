...
const CheckoutEnd = () => {
    ...
    const shipping = cartItems.length > 0 ? 4.90 : 0;

    const deposit = cartItems
        .filter((item) => item.type === "rental")
        .reduce((acc, item) => acc + 17.00 * item.quantity, 0);

    const total = subtotal + shipping + deposit - discount;
                    ...
                    <div className="card p-4 shadow-sm">
                        ...
                        <div className="row">
                            ...
                            <div className="col-md-6 mb-3">
                                <input
                                    name="city"
                                    className={`form-control ${touched.city &&
                                            errors.city
                                            ? "is-invalid"
                                            : ""
                                        }`}
                        ...
                        <div className="row">
                            ...
                            <div className="col-md-6 mb-3">
                                <input
                                    name="postalCode"
                                    className={`form-control ${touched.postalCode &&
                                            errors.postalCode
                                            ? "is-invalid"
                                            : ""
                                        }`}
